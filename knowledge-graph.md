...
-->
<script src="{{ '/assets/js/tao/echarts.min.js' | relative_url }}"></script>
...
const CONCEPT_DEFINITIONS = [
    ...
    { id:'concept:交互优先于交互者', name:'交互优先于交互者', category:'核心概念', color:'#C0392B' },
    { id:'concept:暂态吸引子', name:'暂态吸引子', category:'核心概念', color:'#C0392B' },
    { id:'concept:操作语法', name:'操作语法', category:'核心概念', color:'#C0392B' },
    { id:'concept:筛选语法', name:'筛选语法', category:'核心概念', color:'#C0392B' },
    { id:'concept:呼吸孔', name:'呼吸孔', category:'核心概念', color:'#C0392B' },
    ...
    // =================================================================
    { id:'concept:认识论', name:'认识论', category:'次级概念', color:'#E67E22' },
    { id:'concept:物自体', name:'物自体', category:'次级概念', color:'#E67E22' },
    ...
    { id:'concept:元层', name:'元层', category:'次级概念', color:'#E67E22' }, 
    { id:'concept:算术', name:'算术', category:'次级概念', color:'#E67E22' },
    { id:'concept:几何', name:'几何', category:'次级概念', color:'#E67E22' },
    { id:'concept:微积分', name:'微积分', category:'次级概念', color:'#E67E22' },
    { id:'concept:群论', name:'群论', category:'次级概念', color:'#E67E22' },
    { id:'concept:拓扑学', name:'拓扑学', category:'次级概念', color:'#E67E22' },
    { id:'concept:概率论', name:'概率论', category:'次级概念', color:'#E67E22' },
    { id:'concept:柏拉图主义', name:'柏拉图主义', category:'次级概念', color:'#E67E22' },
    { id:'concept:形式主义', name:'形式主义', category:'次级概念', color:'#E67E22' },
    { id:'concept:直觉主义', name:'直觉主义', category:'次级概念', color:'#E67E22' },
    { id:'concept:数学对象', name:'数学对象', category:'次级概念', color:'#E67E22' },
    { id:'concept:变分自由能', name:'变分自由能', category:'次级概念', color:'#E67E22' },
    { id:'concept:临界判定函数', name:'临界判定函数', category:'次级概念', color:'#E67E22' },
    { id:'concept:模型空间搜索', name:'模型空间搜索', category:'次级概念', color:'#E67E22' },
    { id:'concept:候选规则空间', name:'候选规则空间', category:'次级概念', color:'#E67E22' },
    { id:'concept:路径阻力', name:'路径阻力', category:'次级概念', color:'#E67E22' },
    { id:'concept:历史曲率', name:'历史曲率', category:'次级概念', color:'#E67E22' },
    { id:'concept:模型证据比较', name:'模型证据比较', category:'次级概念', color:'#E67E22' },
    { id:'concept:局部模型', name:'局部模型', category:'次级概念', color:'#E67E22' },
    { id:'concept:环境反馈', name:'环境反馈', category:'次级概念', color:'#E67E22' },
    { id:'concept:相变', name:'相变', category:'次级概念', color:'#E67E22' },
    { id:'concept:元层意识', name:'元层意识', category:'次级概念', color:'#E67E22' },
    { id:'concept:快调节', name:'快调节', category:'次级概念', color:'#E67E22' },
    { id:'concept:慢调节', name:'慢调节', category:'次级概念', color:'#E67E22' },
    { id:'concept:情绪', name:'情绪', category:'次级概念', color:'#E67E22' },
    { id:'concept:快乐', name:'快乐', category:'次级概念', color:'#E67E22' },
    { id:'concept:爱欲', name:'爱欲', category:'次级概念', color:'#E67E22' },
    { id:'concept:生成-女人', name:'生成-女人', category:'次级概念', color:'#E67E22' },
    { id:'concept:历史敏感性', name:'历史敏感性', category:'次级概念', color:'#E67E22' },
    { id:'concept:压缩即智能', name:'压缩即智能', category:'次级概念', color:'#E67E22' },
    { id:'concept:副产物', name:'副产物', category:'次级概念', color:'#E67E22' },
    { id:'concept:认知切割', name:'认知切割', category:'次级概念', color:'#E67E22' },
    { id:'concept:幺正性', name:'幺正性', category:'次级概念', color:'#E67E22' },
    { id:'concept:马尔可夫毯', name:'马尔可夫毯', category:'次级概念', color:'#E67E22' },
    { id:'concept:热力学熵', name:'热力学熵', category:'次级概念', color:'#E67E22' },
    { id:'concept:信息熵', name:'信息熵', category:'次级概念', color:'#E67E22' },
    { id:'concept:渐近极限', name:'渐近极限', category:'次级概念', color:'#E67E22' },
    { id:'concept:可分', name:'可分', category:'次级概念', color:'#E67E22' },
    { id:'concept:纠缠', name:'纠缠', category:'次级概念', color:'#E67E22' },
    { id:'concept:黄金分割', name:'黄金分割', category:'次级概念', color:'#E67E22' },
    // 补充到次级概念部分（橙色）
    { id:'concept:开放性', name:'开放性', category:'次级概念', color:'#E67E22' },
    { id:'concept:记忆', name:'记忆', category:'次级概念', color:'#E67E22' },
    { id:'concept:代理', name:'代理', category:'次级概念', color:'#E67E22' },
    { id:'concept:智能', name:'智能', category:'次级概念', color:'#E67E22' },
    // 新增补全：关系中被引用但未定义的概念
    { id:'concept:数学', name:'数学', category:'次级概念', color:'#E67E22' },
    { id:'concept:概率', name:'概率', category:'次级概念', color:'#E67E22' },
    { id:'concept:自律', name:'自律', category:'次级概念', color:'#E67E22' },
    { id:'concept:先验范畴', name:'先验范畴', category:'次级概念', color:'#E67E22' },
    { id:'concept:道德法则', name:'道德法则', category:'次级概念', color:'#E67E22' },
    { id:'concept:权力意志', name:'权力意志', category:'次级概念', color:'#E67E22' },
    { id:'concept:永恒回归', name:'永恒回归', category:'次级概念', color:'#E67E22' },
    { id:'concept:悲剧', name:'悲剧', category:'次级概念', color:'#E67E22' },
    { id:'concept:超人', name:'超人', category:'次级概念', color:'#E67E22' },
    { id:'concept:他者', name:'他者', category:'次级概念', color:'#E67E22' },
    { id:'concept:预测误差', name:'预测误差', category:'次级概念', color:'#E67E22' },
    // =================================================================
...
const CONCEPT_RELATIONS = [
    ...
    // —— 元公理0：交互优先于交互者 ——
    { source:'concept:交互优先于交互者', target:'concept:关系', type:'奠基' },
    { source:'concept:交互优先于交互者', target:'concept:实体', type:'超越' },
    { source:'concept:暂态吸引子', target:'concept:实体', type:'定义' },
    { source:'concept:暂态吸引子', target:'concept:关系', type:'构成' },
    { source:'concept:交互优先于交互者', target:'concept:暂态吸引子', type:'构成' },
    // —— 数学：操作语法与筛选语法 ——
    { source:'concept:操作语法', target:'concept:数学', type:'构成' },
    { source:'concept:筛选语法', target:'concept:数学', type:'构成' },
    { source:'concept:操作语法', target:'concept:算术', type:'包含' },
    { source:'concept:操作语法', target:'concept:几何', type:'包含' },
    { source:'concept:操作语法', target:'concept:微积分', type:'包含' },
    { source:'concept:操作语法', target:'concept:集合论', type:'包含' },
    { source:'concept:操作语法', target:'concept:群论', type:'包含' },
    { source:'concept:操作语法', target:'concept:拓扑学', type:'包含' },
    { source:'concept:筛选语法', target:'concept:概率论', type:'包含' },
    { source:'concept:概率论', target:'concept:概率', type:'派生' },
    // —— 数学哲学立场 ——
    { source:'concept:柏拉图主义', target:'concept:数学对象', type:'主张' },
    { source:'concept:形式主义', target:'concept:数学对象', type:'主张' },
    { source:'concept:直觉主义', target:'concept:数学对象', type:'主张' },
    { source:'concept:数学对象', target:'concept:实体', type:'类比' },
    // —— 交换模型：可计算机制 ——
    { source:'concept:变分自由能', target:'concept:自由能原理', type:'实现' },
    { source:'concept:临界判定函数', target:'concept:临界点', type:'定义' },
    { source:'concept:模型空间搜索', target:'concept:涌现', type:'机制' },
    { source:'concept:候选规则空间', target:'concept:模型空间搜索', type:'构成' },
    { source:'concept:候选规则空间', target:'concept:历史曲率', type:'来源于' },
    { source:'concept:路径阻力', target:'concept:记忆', type:'构成' },
    { source:'concept:历史曲率', target:'concept:路径阻力', type:'构成' },
    { source:'concept:模型证据比较', target:'concept:涌现', type:'验证' },
    { source:'concept:局部模型', target:'concept:代理', type:'构成' },
    { source:'concept:环境反馈', target:'concept:代理', type:'约束' },
    { source:'concept:相变', target:'concept:临界点', type:'等同' },
    { source:'concept:相变', target:'concept:涌现', type:'产生' },
    // —— 看见漩涡：呼吸孔与裂缝 ——
    { source:'concept:呼吸孔', target:'concept:匮乏', type:'等同' },
    { source:'concept:呼吸孔', target:'concept:裂缝', type:'等同' },
    { source:'concept:呼吸孔', target:'concept:选择性张力', type:'条件' },
    
    // —— 元层意识与递归 ——
    { source:'concept:元层意识', target:'concept:自指', type:'构成' },
    { source:'concept:递归', target:'concept:自指', type:'对比' },
    { source:'concept:递归', target:'concept:动态平衡', type:'构成' },
    { source:'concept:慢调节', target:'concept:自指', type:'机制' },
    { source:'concept:快调节', target:'concept:情绪', type:'机制' },
    { source:'concept:情绪', target:'concept:预测误差', type:'压缩' },
    
    // —— 爱欲与生成 ——
    { source:'concept:爱欲', target:'concept:他者', type:'要求' },
    { source:'concept:爱欲', target:'concept:呼吸孔', type:'打开' },
    { source:'concept:生成-女人', target:'concept:生成', type:'实例' },
    { source:'concept:生成-女人', target:'concept:解域化', type:'实现' },
    
    // —— 业力与历史敏感性 ——
    { source:'concept:业力', target:'concept:记忆', type:'类比' },
    { source:'concept:业力', target:'concept:下行因果', type:'构成' },
    { source:'concept:历史敏感性', target:'concept:业力', type:'等同' },
    { source:'concept:历史敏感性', target:'concept:选择性张力', type:'条件' },
    
    // —— 压缩即智能与副产物 ——
    { source:'concept:压缩即智能', target:'concept:智能', type:'批判' },
    { source:'concept:副产物', target:'concept:智能', type:'定义' },
    { source:'concept:副产物', target:'concept:涌现', type:'实例' },
    // —— 物理层：FEP与量子场 ——
    { source:'concept:幺正性', target:'concept:自由能原理', type:'等价' },
    { source:'concept:马尔可夫毯', target:'concept:选择性张力', type:'数学表达' },
    { source:'concept:热力学熵', target:'concept:信息熵', type:'同构' },
    { source:'concept:信息熵', target:'concept:信息', type:'度量' },
    { source:'concept:热力学熵', target:'concept:耗散结构', type:'背景' },
    { source:'concept:渐近极限', target:'concept:动态平衡', type:'状态' },
    { source:'concept:可分', target:'concept:纠缠', type:'对比' },
    { source:'concept:纠缠', target:'concept:量子纠缠', type:'等同' },
    { source:'concept:纠缠', target:'concept:关系', type:'印证' },
    { source:'concept:黄金分割', target:'concept:动态平衡', type:'印证' },
    { source:'concept:黄金分割', target:'concept:涌现', type:'印证' },
    
    // —— 认知切割 ——
    { source:'concept:认知切割', target:'concept:认知', type:'机制' },
    { source:'concept:认知切割', target:'concept:实体', type:'产生' },
    { source:'concept:认知切割', target:'concept:关系', type:'遮蔽' },
        ...
        allNodes.forEach(function(node) {
            ...
            } else if (node.category === '东方思想') {
                node.itemStyle = { color:PALETTE.eastern };
        ...
        Promise.all(fetchSections).then(function() {
            ...
            function renderGraph(nodes, linksData) {
                const option = {
                    ...
                    legend:[{
                        data:['文章', '分类', '标签', '章节', '核心概念', '次级概念', '哲学家', '案例', '东方思想'],
                        orient:'horizontal',
                        bottom:10,
                    ...
                    series:[{
                        ...
                        categories:[
                            ...
                            { name:'东方思想', itemStyle:{ color:PALETTE.eastern } }
                        ],
                        data:nodes,
                        links:linksData,
